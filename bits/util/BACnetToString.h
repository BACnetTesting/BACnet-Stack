...
const char *IPEP_ToString(char *string, const struct sockaddr_in *ipep);                // String in network order
const char *IPAddr_ToString(char *string, const struct in_addr *ipaddr);			    // hmmm - should be ipaddr, not ipep...
