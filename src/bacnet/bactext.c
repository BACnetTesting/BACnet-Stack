...
static INDTEXT_DATA bacnet_object_type_names[] = {
    ...
    {OBJECT_LOOP, "loop"}
    ,
    {OBJECT_MULTISTATE_INPUT, "multi-state-input"}
    ,
    {OBJECT_MULTISTATE_OUTPUT, "multi-state-output"}
    ,
    ...
    ,
    {OBJECT_MULTISTATE_VALUE, "multi-state-value"}
    ,
...
{
    return indtext_by_index(objTypeAcronyms, (unsigned) type);
}
...
// todo 1 Synonyms - not acronyms.

static INDTEXT_DATA	engineeringUnitAcronyms[] = {
		{ UNITS_KILOWATT_HOURS, "KWH" },
        { UNITS_DEGREES_CELSIUS, "DegC" },
        { UNITS_DEGREES_CELSIUS, "Deg C" },
        { UNITS_DEGREES_CELSIUS, "C" },
        { UNITS_DEGREES_CELSIUS, "Celsius" },
        { UNITS_DEGREES_CELSIUS, "Centigrade" },
        { UNITS_DEGREES_FAHRENHEIT, "Deg F" },
        { UNITS_DEGREES_FAHRENHEIT, "Deg_F" },
        { UNITS_DEGREES_FAHRENHEIT, "F" },
        { UNITS_DEGREES_FAHRENHEIT, "Fahrenheit" },
        { UNITS_AMPERES, "Amps" },
        { UNITS_HERTZ, "Hz" },
        { UNITS_KILOHERTZ, "KHz" },
		{ UNITS_NO_UNITS, "" },
        { UNITS_NO_UNITS, "no_units" },
        { UNITS_NO_UNITS, "no units" },
        { UNITS_NO_UNITS, "none" },
        { UNITS_NO_UNITS, "-" },
        { UNITS_NO_UNITS, "NA" },
...
{
    char mtBuf[100]; 
    uint16_t len = strlen ( bactext_bacnet_mac_address(tbuf, &addr->localMac) ) ;
