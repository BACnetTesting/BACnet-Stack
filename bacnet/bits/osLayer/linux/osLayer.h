...
// 2019.04.01 adding recursive initializer

#define bits_mutex_define(mutexName)        pthread_mutex_t mutexName = PTHREAD_RECURSIVE_MUTEX_INITIALIZER_NP ; // ; PTHREAD_MUTEX_INITIALIZER
