...
void bits_memcpy(void *dest, const void *src, const uint destLen);
void bits_memset(void *dest, const uint8_t val, const uint destLen);
...
// use bits_sysTimer_get_milliseconds in timerCommon.h
